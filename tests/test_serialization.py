...
from crczp.topology_definition.models import BaseBox, Host, Protocol, Router, TopologyDefinition
...
class TestDummy:
	...
	def test_read_yaml_bad_protocol(self, topology_definition_string: str) -> None:
		bad_topology_definition_string = topology_definition_string.replace('winrm', 'InvalidProtocol')
